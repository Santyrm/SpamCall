...
class MyCall {
	...
	* File : run.php
	* Author : AlviToxiz
	* Github : https://github.com/Santyrm
	* Date : 07-06-2021
	...
	public function run(){
		try {
			...
			if(substr($phone, 0, 2) !== "08") {
				throw new Exception("\n \e[31mMessage \e[37m: gunakan angka awalan 08 ya sayang\n\n");
				exit(0);}
			...
			for($coli=0;$coli<=0;$coli++) {
				...
				if(strpos($result, "Request misscall berhasil")) {
					...
					echo "\e[37m\narray(\n       [code] => 30\n       [msisdn] => $phone\n       [message] => Berhasil Terkirim Spam Call 100x\n       [total] => 100\n)\n\n";}}

			echo " \e[37m[\e[33m!\e[37m] Spam lagi? y\n \e[37m[\e[33my\e[37m/\e[33mn\e[37m]\n \e[33m•\e[37m> : ";
			$call = trim(fgets(STDIN));
			if($call == "y" or $call == "Y") { $this->run();} else if($call == "n" or $call == "N") { exit("\n >>> Thank And Jangan Lupa Subscribe YouTube Alvi Toxiz <<<\n\n");} else { exit("\nBy Goblokkk !!\n\n");}
